...
--
-- Хост: db
-- Час створення: Вер 14 2025 р., 08:29
...
(1, 'Default', '', 1, '2025-09-14 08:28:49', '2025-09-14 08:28:49');
...
--
-- Структура таблиці `oc_customer_payment`
--
...
('d2752ab269e0ae0790eea51ef8', '{\"login_token\":\"dfede5ec302694cb7d2a1898e1e3215d\"}', '2025-09-15 08:28:54');
...
(207, 0, 'config', 'config_email', 'admin@admin.com', 0),
(208, 0, 'config', 'config_encryption', '', 0),
...
--
-- Структура таблиці `oc_subscription_transaction`
--
...
(1, 1, 'admin', '$2y$10$sEr5k5s3El.pEPPslnZjcOmEieechwHjgXhCv0oCdDODINarhtK9i', 'John', 'Doe', 'admin@admin.com', '', '', '', 1, '2025-09-14 08:28:49');
...
--
-- Індекси таблиці `oc_customer_payment`
--
...
--
-- Індекси таблиці `oc_subscription_transaction`
--
...
--
-- AUTO_INCREMENT для таблиці `oc_customer_payment`
--
ALTER TABLE `oc_customer_payment`
...
--
-- AUTO_INCREMENT для таблиці `oc_subscription_transaction`
--
ALTER TABLE `oc_subscription_transaction`
...
--
-- AUTO_INCREMENT для таблиці `oc_vendor`
--
ALTER TABLE `oc_vendor`
